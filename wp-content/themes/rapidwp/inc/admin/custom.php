...
// Header styles
if ( ! function_exists( 'rapidwp_header_style' ) ) :
function rapidwp_header_style() {
    ...
    <?php else : ?>
        .rapidwp-site-title, .rapidwp-site-title a, .rapidwp-site-description {color: #<?php echo esc_attr( $header_text_color ); ?>;}
    <?php endif; ?>
    </style>
    <?php
}
